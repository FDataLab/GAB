...
if __name__ == "__main__":
    hyper_grid_config = ConfigHandler.load_hyper_puri_grid(
        purification_type=args.purification, grid_name="hyper_grid"
    )
    ...
    for split_idx in range(0, 5):
        ...
        split_model = ConfigHandler.load_model_config(
            args.model, "best_config", args.dataset, split_idx
        )
