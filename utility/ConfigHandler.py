...
class ConfigHandler:
    ...
    def load_model_config(
        model_type="GCN", config_name="default", dataset=None, split=None
    ):
        if dataset is None or config_name == "default":
            file_path = "{}{}/{}.yaml".format(
                PATH_CONFIG_MODEL, model_type, config_name
            )
        else:
            file_path = "{}{}/{}/split_{}/{}.yaml".format(
                PATH_CONFIG_MODEL, model_type, dataset, split, config_name
            )
    ...
    def save_model_config(
        config, config_name, model_type="GCN", data="cora", split=None
    ):
        file_path = "{}{}/{}/split_{}/".format(
            PATH_CONFIG_MODEL, model_type, data, split
        )
        ...
        print(
            "INFO: save model config successfully at {}{}.yaml".format(
                file_path, config_name
            )
        )

    @staticmethod
    def load_purification_config(
        purification_type="GARNET",
        model_type="GCN",
        config_name="default",
        dataset=None,
        split=None,
        ...
        if dataset is None:
            file_path = "{}{}/{}.yaml".format(
                PATH_CONFIG_PURIFICATION, purification_type, config_name
            )
        else:
            file_path = "{}{}/{}/{}/split_{}/{}.yaml".format(
                PATH_CONFIG_PURIFICATION,
                purification_type,
                model_type,
                dataset,
                split,
    ...
    def save_purification_config(
        ...
        file_path = "{}{}/{}/{}/split_{}/".format(
            PATH_CONFIG_PURIFICATION, purification_type, model_type, data, split
        )
    ...
    def load_hyper_puri_grid(purification_type="GARNET_GCN", grid_name="hyper_grid"):
        file_path = "{}{}/{}.yaml".format(
            PATH_CONFIG_PURIFICATION, purification_type, grid_name
        )
        with open(file_path, "r") as file:
            grid = yaml.safe_load(file)
        return grid
